...
const PRESETS = {
  ...
  'Tilt-A-Whirl':  { scale: 20, lift: 15, wobble: 100,squash: 10, stiffness: 300, damping: 7,  mass: 0.9 },
  'Confident':     { scale: 30, lift: 18, wobble: 0,  squash: 15, stiffness: 450, damping: 22, mass: 0.8 },
  'Nervous Tick':  { scale: 10, lift: 5,  wobble: 60, squash: 5,  stiffness: 500, damping: 3,  mass: 0.3 },
  'Puppy Jump':    { scale: 50, lift: 70, wobble: 12, squash: 40, stiffness: 220, damping: 7,  mass: 0.6 },
  'Slow Bloom':    { scale: 80, lift: 5,  wobble: 0,  squash: 25, stiffness: 80,  damping: 14, mass: 2.5 },
  'Ping':          { scale: 40, lift: 0,  wobble: 0,  squash: 0,  stiffness: 500, damping: 18, mass: 0.4 },
};

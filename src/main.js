...
const PRESETS = {
  ...
  'Subtle Nod':    { scale: 15, lift: 20, wobble: 0,  squash: 8,  stiffness: 400, damping: 20, mass: 1.0 },
  ...
  'Nervous Tick':  { scale: 10, lift: 8,  wobble: 60, squash: 5,  stiffness: 500, damping: 3,  mass: 0.3 },
  ...
  'Typewriter Key':{ scale: 5,  lift: 15, wobble: 0,  squash: 22, stiffness: 500, damping: 30, mass: 0.5 },
  'Popcorn':       { scale: 32, lift: 60, wobble: 12, squash: 52, stiffness: 430, damping: 8,  mass: 0.4 },
  'Diving Board':  { scale: 14, lift: 100,wobble: 5,  squash: 58, stiffness: 175, damping: 7,  mass: 1.1 },
};
